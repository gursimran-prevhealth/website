            ...
            <div className="w-full h-full flex items-end justify-end mt-auto">
              <div className="w-full lg:max-w-[579px] flex flex-col items-start gap-3 md:gap-4">
                ...
                <p className="text-base md:text-xl text-[#555] font-light font-worksans leading-[135%]">
                  ...
                  providers through secure chat, call, or video. Follow-ups and
                  updates are built in, so they feel supported every step of the
                  way.
                </p>
                <Button>
            ...
            <div className="w-full h-full flex items-end justify-start mt-auto">
              <div className="w-full lg:max-w-[579px] flex flex-col items-start gap-3 md:gap-4">
                ...
                <p className="text-base md:text-xl text-[#555] font-light font-worksans leading-[135%]">
                  ...
                  appointments, fewer forms, and a more connected experience,
