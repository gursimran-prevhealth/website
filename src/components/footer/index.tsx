    ...
    <div className="w-full bg-neutral-100 py-12 md:py-28 px-4 sm:px-6 lg:px-20">
      <div className="max-w-7xl mx-auto flex flex-col gap-8 md:gap-12">
          ...
          <div className="flex flex-col gap-6 max-w-[709px]">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-zinc-500 text-base font-normal tracking-wider font-[Work_Sans]">
                  contact@clinvvo.ai
                </span>
              </div>
              {/* <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-16">
            ...
            <div className="flex flex-col gap-4 w-36">
              {navItems.slice(3, 5).map((link, idx) => (
                ...
                >
                  <span className="text-zinc-500  tracking-wider text-base font-normal font-[Work_Sans] group-hover:text-[#23586A]">
                    {link.label}
                  </span>
                  <div className="w-0 h-0.5 bg-cyan-900 rounded-lg group-hover:w-full transition-all" />
                </Link>
        ...
        <div className="flex flex-row justify-between items-center gap-4">
          <span className="text-zinc-500 tracking-wider text-sm md:text-xl font-normal font-[Work_Sans]">
            {t("footer.copyright")}
          </span>
          <a
            href={"https://www.linkedin.com/company/clinvvo/"}
            target="_blank"
