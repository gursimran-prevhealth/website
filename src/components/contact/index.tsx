    ...
    return (
      <section className="w-full px-5 sm:pb-32 pb-14 pt-8 sm:min-h-screen">
        ...
        <div className="w-full max-w-[1400px] mx-auto bg-cyan-900 rounded-xl overflow-hidden p-8 md:p-16 md:min-h-64 flex flex-col md:flex-row justify-between md:items-center items-start gap-8 -mt-12 md:-mt-40 relative z-[1]">
          ...
          <Link
            to={"/contact-us"}
            className="bg-white tracking-wider cursor-pointer text-[#23586A] text-sm md:text-base tracking-wider font-medium font-[Work_Sans] leading-tight md:leading-snug px-6 py-3.5 md:px-8 md:py-4 rounded-[48px] hover:bg-cyan-50 transition-colors duration-200"
          >
            Contact Us
          </Link>
        </div>
