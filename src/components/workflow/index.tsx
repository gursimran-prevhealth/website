          ...
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col gap-4 md:gap-5">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[#545454] text-sm md:text-base lg:text-xl font-light tracking-wider font-['Work_Sans'] leading-snug md:leading-normal lg:leading-7">
                  {step.desc}
                </p>
              </div>
            </div>
        ...
        {/* <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-3">
          <div className="flex flex-col gap-4 md:gap-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[#545454] text-sm md:text-base lg:text-xl font-light tracking-wider font-['Work_Sans'] leading-snug md:leading-normal lg:leading-7">
                Select the region, department, preferred template & configure
                microphone settings, then start your session with the patient.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 md:gap-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[#545454] text-sm md:text-base lg:text-xl font-light tracking-wider font-['Work_Sans'] leading-snug md:leading-normal lg:leading-7">
                After the consultation, our AI transcribes the recording and
                creates a structured medical note—clear, accurate, and ready to
                use.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 md:gap-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[#545454] text-sm md:text-base lg:text-xl font-light tracking-wider font-['Work_Sans'] leading-snug md:leading-normal lg:leading-7">
                Edit by voice or text, make any changes, then transfer the note
                to the patient's medical journal.
              </p>
            </div>
          </div>
        </div> */}
